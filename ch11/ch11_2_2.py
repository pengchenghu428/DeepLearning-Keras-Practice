# -*- coding: utf-8 -*-
# @Time    : 2018/10/3 15:48
# @Author  : pengchenghu
# @FileName: ch11_2_2.py
# @Software: PyCharm
# @Dropout 与学习率衰减：在隐藏层使用Dropout
...
K.clear_session()  # 清理所有tensorflow 的session, 防止 'Nonetype': object is not callable
...
def create_model(init='glorot_uniform'):
    ...
    model = Sequential()
    '''
    kernel_constraint: 在优化过程中为网络的参数施加约束,对主权重矩阵进行约束
    预定义约束项:
        max_norm(m=2)：最大值约束
        non_neg()：非负性约束
